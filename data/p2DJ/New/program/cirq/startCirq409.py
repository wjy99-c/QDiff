...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(1.7844246272390027).on(input_qubit[0])) # number=17
    c.append(cirq.H.on(input_qubit[0])) # number=15
    c.append(cirq.rx(0.634601716025138).on(input_qubit[0])) # number=5
    c.append(cirq.Y.on(input_qubit[0])) # number=4
    ...
    c.append(cirq.Y.on(input_qubit[0])) # number=11
    c.append(cirq.Y.on(input_qubit[0])) # number=12
    c.append(cirq.Y.on(input_qubit[0])) # number=13
    c.append(cirq.Z.on(input_qubit[0])) # number=18
    c.append(cirq.X.on(input_qubit[0])) # number=20
    c.append(cirq.X.on(input_qubit[0])) # number=21
    # circuit end
