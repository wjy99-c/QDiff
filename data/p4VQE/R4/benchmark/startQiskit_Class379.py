...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[1],input_qubit[2]) # number=10
    ...
    prog.swap(input_qubit[3],input_qubit[0]) # number=11
    prog.swap(input_qubit[3],input_qubit[0]) # number=12
    # circuit end
...
if __name__ == '__main__':
    ...
    prog = make_circuit(4)
    sample_shot =5600
    writefile = open("../data/startQiskit_Class379.csv", "w")
