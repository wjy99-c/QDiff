...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=12
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=18
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=15
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq_pragma850.csv","w+")
