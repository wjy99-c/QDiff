...
def build_circuit(n: int, f: Callable[[str], str]) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[0],input_qubit[2]) # number=64
    prog.x(input_qubit[2]) # number=65
    prog.cx(input_qubit[0],input_qubit[2]) # number=66
...
if __name__ == "__main__":
    ...
    sample_shot =4000
    writefile = open("../data/startQiskit_noisy339.csv", "w")
