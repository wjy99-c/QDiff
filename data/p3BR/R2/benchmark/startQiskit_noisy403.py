...
def build_circuit(n: int, f: Callable[[str], str]) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[0],input_qubit[1]) # number=76
    prog.x(input_qubit[1]) # number=77
    prog.cx(input_qubit[0],input_qubit[1]) # number=78
...
if __name__ == "__main__":
    ...
    sample_shot =4000
    writefile = open("../data/startQiskit_noisy403.csv", "w")
