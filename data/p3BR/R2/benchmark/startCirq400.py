...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.X.on(input_qubit[2])) # number=74
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[1])) # number=75
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=76
    c.append(cirq.X.on(input_qubit[2])) # number=77
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=78
    # circuit end
