...
def build_circuit(n: int, f: Callable[[str], str]) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[0],input_qubit[2]) # number=67
    prog.x(input_qubit[2]) # number=68
    prog.cx(input_qubit[0],input_qubit[2]) # number=69
...
if __name__ == "__main__":
    ...
    sample_shot =4000
    writefile = open("../data/startQiskit_noisy352.csv", "w")
