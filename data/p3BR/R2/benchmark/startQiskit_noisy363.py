...
def build_circuit(n: int, f: Callable[[str], str]) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[2],input_qubit[0]) # number=70
    prog.z(input_qubit[2]) # number=71
    prog.cx(input_qubit[2],input_qubit[0]) # number=72
...
if __name__ == "__main__":
    ...
    sample_shot =4000
    writefile = open("../data/startQiskit_noisy363.csv", "w")
