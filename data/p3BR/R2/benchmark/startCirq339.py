...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=64
    c.append(cirq.X.on(input_qubit[2])) # number=65
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=66
