...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=14
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=15
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq89.csv","w+")
