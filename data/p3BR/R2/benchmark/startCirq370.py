...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=71
    c.append(cirq.X.on(input_qubit[2])) # number=72
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=73
