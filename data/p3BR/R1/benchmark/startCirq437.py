...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=77
    c.append(cirq.X.on(input_qubit[1])) # number=78
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=79
