...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[0],input_qubit[4]) # number=60
    prog.x(input_qubit[4]) # number=61
    prog.cx(input_qubit[0],input_qubit[4]) # number=62
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1873.csv","w")
