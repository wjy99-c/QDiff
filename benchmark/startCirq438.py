...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=51
    c.append(cirq.Z.on(input_qubit[1])) # number=52
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=53
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq438.csv","w+")
