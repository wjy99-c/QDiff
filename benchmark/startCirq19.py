...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=23
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=24
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq19.csv","w+")
