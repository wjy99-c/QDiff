...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=41
    c.append(cirq.Z.on(input_qubit[2])) # number=42
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=43
    c.append(cirq.H.on(input_qubit[2]))  # number=3
    c.append(cirq.H.on(input_qubit[3]))  # number=4
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=31
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=37
    c.append(cirq.Z.on(input_qubit[3])) # number=38
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=35
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3]))  # number=23
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3184.csv","w+")
