...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=51
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=52
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1101.csv","w+")
