...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(1.573937919448486).on(input_qubit[3])) # number=46
    ...
    c.append(cirq.H.on(input_qubit[3])) # number=55
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3])) # number=56
    c.append(cirq.H.on(input_qubit[3])) # number=57
    c.append(cirq.X.on(input_qubit[3])) # number=53
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=54
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[3])) # number=48
    c.append(cirq.H.on(input_qubit[3])) # number=49
    c.append(cirq.H.on(input_qubit[1])) # number=42
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=43
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=51
    ...
    c.append(cirq.H.on(input_qubit[3])) # number=58
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3])) # number=59
    c.append(cirq.H.on(input_qubit[3])) # number=60
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=8
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=39
    c.append(cirq.rx(2.626371458401067).on(input_qubit[2])) # number=50
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq490.csv","w+")
