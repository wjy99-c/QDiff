...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[0],input_qubit[1]) # number=56
        prog.x(input_qubit[1]) # number=57
        prog.cx(input_qubit[0],input_qubit[1]) # number=58
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1659.csv","w")
