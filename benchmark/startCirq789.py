...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=35
        c.append(cirq.X.on(input_qubit[4])) # number=36
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=37
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq789.csv","w+")
