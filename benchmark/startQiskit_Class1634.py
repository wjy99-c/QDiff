...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.z(input_qubit[2]) # number=17
    prog.h(input_qubit[1]) # number=24
    prog.cz(input_qubit[2],input_qubit[1]) # number=25
    prog.h(input_qubit[1]) # number=26
    prog.z(input_qubit[1]) # number=21
    prog.h(input_qubit[1]) # number=2
    prog.h(input_qubit[2])  # number=3
    prog.rx(-2.0106192982974678,input_qubit[2]) # number=28
    ...
    prog.cz(input_qubit[1],input_qubit[3]) # number=30
    ...
    prog.x(input_qubit[2]) # number=16
    prog.x(input_qubit[0]) # number=19
    prog.x(input_qubit[0]) # number=20
    prog.swap(input_qubit[1],input_qubit[0]) # number=32
    prog.swap(input_qubit[1],input_qubit[0]) # number=33
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1634.csv","w")
