...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=48
    c.append(cirq.Z.on(input_qubit[2])) # number=49
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=50
