...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[0],input_qubit[3]) # number=58
    prog.x(input_qubit[3]) # number=59
    prog.cx(input_qubit[0],input_qubit[3]) # number=60
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy489.csv","w")
