...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=39
    c.append(cirq.Z.on(input_qubit[4])) # number=40
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=41
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq853.csv","w+")
