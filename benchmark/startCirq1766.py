...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=63
    c.append(cirq.Z.on(input_qubit[4])) # number=64
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=65
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1766.csv","w+")
