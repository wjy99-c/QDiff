...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=38
        ...
        c.append(cirq.CNOT.on(input_qubit[2],input_qubit[4])) # number=37
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq955.csv","w+")
