...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[4],input_qubit[0]) # number=29
    prog.z(input_qubit[4]) # number=30
    prog.cx(input_qubit[4],input_qubit[0]) # number=31
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class280.csv","w")
