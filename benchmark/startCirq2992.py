...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=29
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=30
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq2992.csv","w+")
