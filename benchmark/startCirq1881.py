...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=66
    c.append(cirq.Z.on(input_qubit[4])) # number=67
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=68
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=60
        c.append(cirq.Z.on(input_qubit[3])) # number=61
        c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=62
        ...
        c.append(cirq.CZ.on(input_qubit[1],input_qubit[0]))  # number=64
        c.append(cirq.H.on(input_qubit[0]))  # number=65
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1881.csv","w+")
