...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[0])) # number=44
    c.append(cirq.H.on(input_qubit[0])) # number=45
    c.append(cirq.Z.on(input_qubit[3])) # number=21
    c.append(cirq.H.on(input_qubit[0])) # number=27
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[0])) # number=28
    c.append(cirq.H.on(input_qubit[0])) # number=29
    c.append(cirq.H.on(input_qubit[3]))  # number=8
    c.append(cirq.H.on(input_qubit[3]))  # number=23
    c.append(cirq.rx(-0.6848671984825748).on(input_qubit[1])) # number=26
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3]))  # number=38
    ...
    c.append(cirq.X.on(input_qubit[3]))  # number=41
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3]))  # number=42
    c.append(cirq.H.on(input_qubit[3]))  # number=46
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3]))  # number=47
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3315.csv","w+")
