...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[0],input_qubit[3]) # number=52
    prog.cx(input_qubit[0],input_qubit[3]) # number=55
    prog.x(input_qubit[3]) # number=56
    prog.cx(input_qubit[0],input_qubit[3]) # number=57
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy474.csv","w")
