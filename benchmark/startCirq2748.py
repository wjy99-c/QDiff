...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3]))  # number=43
    c.append(cirq.X.on(input_qubit[3]))  # number=44
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3]))  # number=45
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq2748.csv","w+")
