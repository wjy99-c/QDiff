...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(1):
        ...
        prog.cx(input_qubit[0],input_qubit[4]) # number=35
        prog.x(input_qubit[4]) # number=36
        prog.cx(input_qubit[0],input_qubit[4]) # number=37
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class789.csv","w")
