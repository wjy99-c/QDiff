...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[4],input_qubit[0]) # number=39
    prog.z(input_qubit[4]) # number=40
    prog.cx(input_qubit[4],input_qubit[0]) # number=41
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class851.csv","w")
