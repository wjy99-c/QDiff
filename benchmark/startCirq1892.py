...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.H.on(input_qubit[1])) # number=60
        c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=61
        c.append(cirq.H.on(input_qubit[1])) # number=62
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1892.csv","w+")
