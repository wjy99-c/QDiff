...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Y.on(input_qubit[1])) # number=19
    ...
    c.append(cirq.rx(-2.158274153016188).on(input_qubit[3])) # number=24
    ...
    c.append(cirq.Z.on(input_qubit[1])) # number=22
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=23
    c.append(cirq.H.on(input_qubit[0])) # number=25
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=26
    c.append(cirq.H.on(input_qubit[0])) # number=27
    c.append(cirq.X.on(input_qubit[0])) # number=35
    c.append(cirq.X.on(input_qubit[0])) # number=36
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3274.csv","w+")
