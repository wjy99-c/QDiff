...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[1],input_qubit[0])) # number=68
    c.append(cirq.SWAP.on(input_qubit[1],input_qubit[0])) # number=69
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1902.csv","w+")
