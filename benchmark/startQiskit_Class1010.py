...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[0],input_qubit[4]) # number=38
        prog.x(input_qubit[4]) # number=39
        prog.cx(input_qubit[0],input_qubit[4]) # number=40
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1010.csv","w")
