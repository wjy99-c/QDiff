...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=57
        c.append(cirq.X.on(input_qubit[2])) # number=58
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=59
        ...
        c.append(cirq.rx(1.7844246272390027).on(input_qubit[4])) # number=56
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1826.csv","w+")
