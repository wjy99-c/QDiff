...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=52
    c.append(cirq.Z.on(input_qubit[4])) # number=53
    ...
    c.append(cirq.Z.on(input_qubit[3])) # number=51
    for i in range(2):
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1909.csv","w+")
