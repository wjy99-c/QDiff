...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Y.on(input_qubit[2])) # number=25
    c.append(cirq.H.on(input_qubit[1])) # number=21
    c.append(cirq.rx(1.9289378893041333).on(input_qubit[2])) # number=29
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[1])) # number=22
    c.append(cirq.H.on(input_qubit[1])) # number=23
    c.append(cirq.H.on(input_qubit[2]))  # number=3
    c.append(cirq.H.on(input_qubit[3]))  # number=4
    c.append(cirq.H.on(input_qubit[0])) # number=12
    c.append(cirq.Z.on(input_qubit[3])) # number=17
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=24
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=31
    c.append(cirq.Z.on(input_qubit[2])) # number=32
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=33
    c.append(cirq.Y.on(input_qubit[2])) # number=26
    c.append(cirq.Y.on(input_qubit[2])) # number=27
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1660.csv","w+")
