...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[2],input_qubit[1]) # number=21
    ...
    prog.y(input_qubit[0]) # number=22
    prog.y(input_qubit[0]) # number=23
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class763.csv","w")
