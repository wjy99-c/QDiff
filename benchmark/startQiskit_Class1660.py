...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.y(input_qubit[2]) # number=25
    prog.h(input_qubit[1]) # number=21
    prog.rx(1.9289378893041333,input_qubit[2]) # number=29
    ...
    prog.z(input_qubit[3]) # number=17
    ...
    prog.cx(input_qubit[3],input_qubit[1]) # number=24
    ...
    prog.z(input_qubit[2]) # number=32
    prog.cx(input_qubit[2],input_qubit[0]) # number=33
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1660.csv","w")
