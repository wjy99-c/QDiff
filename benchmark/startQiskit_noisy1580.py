...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[4],input_qubit[0]) # number=55
    prog.z(input_qubit[4]) # number=56
    prog.cx(input_qubit[4],input_qubit[0]) # number=57
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy1580.csv","w")
