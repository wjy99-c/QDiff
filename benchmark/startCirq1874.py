...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=60
    c.append(cirq.X.on(input_qubit[4])) # number=61
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=62
    ...
    for i in range(2):
        ...
        c.append(cirq.Z.on(input_qubit[1])) # number=58
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1874.csv","w+")
