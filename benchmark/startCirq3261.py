...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3]))  # number=28
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3]))  # number=49
    c.append(cirq.X.on(input_qubit[3]))  # number=50
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3]))  # number=51
    ...
    c.append(cirq.rx(-0.364424747816416).on(input_qubit[3])) # number=36
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3261.csv","w+")
