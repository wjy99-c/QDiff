...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=57
    c.append(cirq.X.on(input_qubit[4])) # number=58
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=59
