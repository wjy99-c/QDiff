...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(-0.9927432785343745).on(input_qubit[1])) # number=43
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=37
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=44
    c.append(cirq.Z.on(input_qubit[2])) # number=45
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=41
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3215.csv","w+")
