...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[0],input_qubit[3]) # number=51
    prog.x(input_qubit[3]) # number=52
    prog.cx(input_qubit[0],input_qubit[3]) # number=53
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy427.csv","w")
