...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[3],input_qubit[0]) # number=57
        prog.z(input_qubit[3]) # number=58
        prog.cx(input_qubit[3],input_qubit[0]) # number=59
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1538.csv","w")
