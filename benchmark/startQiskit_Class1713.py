...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.cz(input_qubit[3],input_qubit[0]) # number=20
    prog.h(input_qubit[0]) # number=21
    prog.rx(-2.959380279681585,input_qubit[2]) # number=11
    prog.rx(-0.4963716392671874,input_qubit[2]) # number=25
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1713.csv","w")
