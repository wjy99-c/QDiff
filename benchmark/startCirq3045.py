...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[1])) # number=32
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[0])) # number=25
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3045.csv","w+")
