...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[1],input_qubit[0])  # number=60
        prog.x(input_qubit[0])  # number=61
        prog.cx(input_qubit[1],input_qubit[0])  # number=62
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy1893.csv","w")
