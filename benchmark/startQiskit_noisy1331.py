...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[0],input_qubit[2])  # number=57
        prog.x(input_qubit[2])  # number=58
        prog.cx(input_qubit[0],input_qubit[2])  # number=59
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy1331.csv","w")
