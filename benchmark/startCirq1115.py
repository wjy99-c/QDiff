...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=43
    c.append(cirq.Z.on(input_qubit[4])) # number=44
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=45
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1115.csv","w+")
