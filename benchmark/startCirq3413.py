...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[2])) # number=37
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=45
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[3])) # number=34
    c.append(cirq.H.on(input_qubit[3])) # number=35
    c.append(cirq.X.on(input_qubit[2])) # number=42
    c.append(cirq.X.on(input_qubit[2])) # number=43
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3413.csv","w+")
