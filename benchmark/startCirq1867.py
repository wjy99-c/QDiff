...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=60
        c.append(cirq.Z.on(input_qubit[1])) # number=61
        c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=62
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1867.csv","w+")
