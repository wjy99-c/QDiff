...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0]))  # number=63
        c.append(cirq.X.on(input_qubit[0]))  # number=64
        c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0]))  # number=65
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1769.csv","w+")
