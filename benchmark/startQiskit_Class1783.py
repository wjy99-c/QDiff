...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[1],input_qubit[0])  # number=67
        prog.x(input_qubit[0])  # number=68
        prog.cx(input_qubit[1],input_qubit[0])  # number=69
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1783.csv","w")
