...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=28
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=29
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1283.csv","w+")
