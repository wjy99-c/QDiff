...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Y.on(input_qubit[0])) # number=21
    c.append(cirq.rx(1.6807520696705391).on(input_qubit[0])) # number=15
    ...
    c.append(cirq.Y.on(input_qubit[0])) # number=10
    ...
    c.append(cirq.Y.on(input_qubit[0])) # number=8
    c.append(cirq.Y.on(input_qubit[0])) # number=9
    ...
    c.append(cirq.Y.on(input_qubit[0])) # number=20
    c.append(cirq.Y.on(input_qubit[0])) # number=18
    c.append(cirq.Y.on(input_qubit[0])) # number=19
    c.append(cirq.X.on(input_qubit[0])) # number=22
    c.append(cirq.X.on(input_qubit[0])) # number=23
    c.append(cirq.X.on(input_qubit[0])) # number=24
    c.append(cirq.X.on(input_qubit[0])) # number=25
    c.append(cirq.Y.on(input_qubit[0])) # number=26
    c.append(cirq.Y.on(input_qubit[0])) # number=27
    # circuit end
