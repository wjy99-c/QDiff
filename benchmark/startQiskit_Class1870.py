...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[2],input_qubit[0]) # number=60
    prog.z(input_qubit[2]) # number=61
    prog.cx(input_qubit[2],input_qubit[0]) # number=62
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1870.csv","w")
