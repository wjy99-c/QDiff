...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=40
    ...
    c.append(cirq.SWAP.on(input_qubit[1],input_qubit[0])) # number=41
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3368.csv","w+")
