...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=53
        c.append(cirq.X.on(input_qubit[2])) # number=54
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=55
