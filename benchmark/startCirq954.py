...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.H.on(input_qubit[4])) # number=42
        c.append(cirq.CZ.on(input_qubit[2],input_qubit[4])) # number=43
        c.append(cirq.H.on(input_qubit[4])) # number=44
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq954.csv","w+")
