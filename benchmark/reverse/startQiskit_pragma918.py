...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.z(input_qubit[0]) # number=22
    prog.cx(input_qubit[0],input_qubit[1]) # number=23
    prog.x(input_qubit[2]) # number=5
    prog.cx(input_qubit[0],input_qubit[3]) # number=8
    prog.h(input_qubit[3]) # number=18
    prog.cz(input_qubit[0],input_qubit[3]) # number=19
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma918.csv","w")
