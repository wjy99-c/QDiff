...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Z.on(input_qubit[3])) # number=8
    c.append(cirq.H.on(input_qubit[1])) # number=4
    c.append(cirq.rx(-0.8450884238156544).on(input_qubit[1])) # number=13
    ...
    c.append(cirq.rx(-2.5101325302182445).on(input_qubit[4])) # number=11
    c.append(cirq.Z.on(input_qubit[1])) # number=10
    c.append(cirq.rx(-1.6807520696705391).on(input_qubit[2])) # number=9
    c.append(cirq.CNOT.on(input_qubit[1], input_qubit[2])) # number=2
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=15
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=16
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=16
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=15
    c.append(cirq.CNOT.on(input_qubit[1], input_qubit[2])) # number=2
    c.append(cirq.rx(-1.6807520696705391).on(input_qubit[2])) # number=9
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma871.csv","w+")
