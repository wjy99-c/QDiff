...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Z.on(input_qubit[0])) # number=19
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=20
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma779.csv","w+")
