...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.h(input_qubit[3]) # number=14
    prog.h(input_qubit[1]) # number=4
    prog.x(input_qubit[1]) # number=15
    ...
    prog.cx(input_qubit[3],input_qubit[1]) # number=12
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma743.csv","w")
