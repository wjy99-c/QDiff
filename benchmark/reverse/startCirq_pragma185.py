...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=12
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=13
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=13
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=12
    c.append(cirq.H.on( input_qubit[2])) # number=10
    c.append(cirq.CZ.on(input_qubit[1], input_qubit[2])) # number=9
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma185.csv","w+")
