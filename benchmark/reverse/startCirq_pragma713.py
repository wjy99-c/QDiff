...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Z.on(input_qubit[3])) # number=15
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=16
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma713.csv","w+")
