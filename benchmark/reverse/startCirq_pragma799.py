...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.H.on(input_qubit[2])) # number=16
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[2])) # number=17
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma799.csv","w+")
