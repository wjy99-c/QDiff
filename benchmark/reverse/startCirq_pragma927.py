...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[1], input_qubit[3])) # number=20
    c.append(cirq.H.on( input_qubit[3])) # number=21
    c.append(cirq.rx(-1.4042919161546374).on(input_qubit[2])) # number=18
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma927.csv","w+")
