...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Z.on(input_qubit[0])) # number=20
    ...
    c.append(cirq.rx(1.8912387774610557).on(input_qubit[1])) # number=18
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma904.csv","w+")
