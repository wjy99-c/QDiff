...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[1],input_qubit[2]) # number=17
    prog.cx(input_qubit[1],input_qubit[4]) # number=16
    ...
    prog.x(input_qubit[3]) # number=19
    prog.cx(input_qubit[0],input_qubit[3]) # number=20
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma862.csv","w")
