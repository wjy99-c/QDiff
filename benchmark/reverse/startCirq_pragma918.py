...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(3.0096457621390216).on(input_qubit[3])) # number=16
    c.append(cirq.X.on(input_qubit[0])) # number=17
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=21
    c.append(cirq.Z.on(input_qubit[0])) # number=22
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma918.csv","w+")
