...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=13
    c.append(cirq.X.on(input_qubit[2])) # number=14
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=15
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma555.csv","w+")
