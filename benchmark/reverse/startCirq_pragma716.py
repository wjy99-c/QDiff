...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.H.on( input_qubit[3])) # number=14
    c.append(cirq.CZ.on(input_qubit[1], input_qubit[3])) # number=15
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma716.csv","w+")
