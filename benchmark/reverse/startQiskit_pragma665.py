...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.z(input_qubit[1]) # number=14
    ...
    prog.cx(input_qubit[2],input_qubit[0]) # number=15
    prog.cx(input_qubit[2],input_qubit[0]) # number=16
    prog.cx(input_qubit[2],input_qubit[0]) # number=16
    prog.cx(input_qubit[2],input_qubit[0]) # number=15
    prog.cx(input_qubit[1],input_qubit[2])  # number=2
    prog.h(input_qubit[3])  # number=10
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma665.csv","w")
