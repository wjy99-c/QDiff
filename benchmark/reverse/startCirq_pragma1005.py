...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(-1.5770795121020762).on(input_qubit[2])) # number=16
    ...
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=17
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma1005.csv","w+")
