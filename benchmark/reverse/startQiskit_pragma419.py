...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.h(input_qubit[4]) # number=14
    prog.cz(input_qubit[1],input_qubit[4]) # number=15
    prog.h(input_qubit[4]) # number=16
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma419.csv","w")
