...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.H.on(input_qubit[4])) # number=18
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[4])) # number=19
    c.append(cirq.H.on(input_qubit[4])) # number=20
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma860.csv","w+")
