...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=14
    c.append(cirq.Z.on(input_qubit[1])) # number=15
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma719.csv","w+")
