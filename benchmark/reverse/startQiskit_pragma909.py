...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.rx(3.0096457621390216,input_qubit[3]) # number=16
    prog.x(input_qubit[0]) # number=17
    prog.cx(input_qubit[0],input_qubit[1]) # number=19
    prog.z(input_qubit[0]) # number=20
    prog.cx(input_qubit[0],input_qubit[1]) # number=21
    ...
    prog.rx(1.8912387774610557,input_qubit[1]) # number=18
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma909.csv","w")
