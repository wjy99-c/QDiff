...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=13
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=14
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=14
    c.append(cirq.SWAP.on(input_qubit[4],input_qubit[0])) # number=13
    c.append(cirq.CNOT.on(input_qubit[1], input_qubit[2])) # number=2
    c.append(cirq.H.on( input_qubit[3])) # number=10
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma375.csv","w+")
