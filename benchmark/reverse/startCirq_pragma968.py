...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.H.on(input_qubit[3])) # number=11
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[2])) # number=14
    c.append(cirq.Y.on(input_qubit[3])) # number=12
    c.append(cirq.H.on(input_qubit[1])) # number=4
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=8
    c.append(cirq.X.on(input_qubit[2])) # number=9
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[2])) # number=16
    c.append(cirq.rx(-1.6807520696705391).on(input_qubit[2])) # number=15
    c.append(cirq.CNOT.on(input_qubit[1], input_qubit[2])) # number=2
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=17
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=18
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=18
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[0])) # number=17
    c.append(cirq.CNOT.on(input_qubit[1], input_qubit[2])) # number=2
    c.append(cirq.rx(-1.6807520696705391).on(input_qubit[2])) # number=15
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma968.csv","w+")
