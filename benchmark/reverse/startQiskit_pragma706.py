...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.h(input_qubit[4]) # number=17
    prog.cz(input_qubit[1],input_qubit[4]) # number=18
    prog.h(input_qubit[4]) # number=19
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma706.csv","w")
