...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.rx(2.243097154663112,input_qubit[4]) # number=18
    prog.h(input_qubit[1]) # number=4
    prog.cx(input_qubit[0],input_qubit[2]) # number=12
    prog.rx(1.5205308443374599,input_qubit[2]) # number=15
    ...
    prog.z(input_qubit[0]) # number=17
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma946.csv","w")
