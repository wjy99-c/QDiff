...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.rx(-1.5770795121020762,input_qubit[2]) # number=16
    prog.h(input_qubit[1]) # number=4
    prog.cx(input_qubit[1],input_qubit[2]) # number=15
    prog.x(input_qubit[2]) # number=5
    prog.cx(input_qubit[0],input_qubit[1]) # number=17
    prog.x(input_qubit[1]) # number=18
    prog.cx(input_qubit[0],input_qubit[1]) # number=19
    ...
    prog.rx(1.925796296650543,input_qubit[2]) # number=13
    prog.y(input_qubit[0]) # number=12
    prog.x(input_qubit[4]) # number=11
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma1003.csv","w")
