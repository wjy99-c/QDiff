...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=15
    ...
    c.append(cirq.Y.on(input_qubit[4])) # number=14
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[4])) # number=12
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[2])) # number=11
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma722.csv","w+")
