...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.h(input_qubit[4]) # number=18
    prog.cz(input_qubit[1],input_qubit[4]) # number=19
    prog.h(input_qubit[4]) # number=20
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startQiskit_pragma860.csv","w")
