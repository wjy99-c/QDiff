...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.H.on(input_qubit[4])) # number=14
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[4])) # number=15
    c.append(cirq.H.on(input_qubit[4])) # number=16
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma419.csv","w+")
