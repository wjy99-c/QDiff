...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=17
    c.append(cirq.X.on(input_qubit[4])) # number=18
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=19
    c.append(cirq.rx(-1.156106096521044).on(input_qubit[3])) # number=15
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[3])) # number=14
    c.append(cirq.H.on(input_qubit[2])) # number=13
    c.append(cirq.Z.on(input_qubit[3])) # number=12
    c.append(cirq.Z.on(input_qubit[1])) # number=11
    c.append(cirq.H.on( input_qubit[2])) # number=8
    c.append(cirq.CZ.on(input_qubit[1], input_qubit[2])) # number=9
    c.append(cirq.H.on( input_qubit[2])) # number=10
    c.append(cirq.H.on( input_qubit[2])) # number=10
    c.append(cirq.CZ.on(input_qubit[1], input_qubit[2])) # number=9
    c.append(cirq.H.on( input_qubit[2])) # number=8
    c.append(cirq.Z.on(input_qubit[1])) # number=11
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma981.csv","w+")
