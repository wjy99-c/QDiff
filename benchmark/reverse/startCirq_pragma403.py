...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.H.on( input_qubit[2])) # number=12
    c.append(cirq.CZ.on(input_qubit[1], input_qubit[2])) # number=13
...
if __name__ == '__main__':
    ...
    writefile = open("../data/reverse/startCirq_pragma403.csv","w+")
