...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=54
    c.append(cirq.X.on(input_qubit[4])) # number=55
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=56
