...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=38
    ...
    for i in range(2):
        ...
        c.append(cirq.Y.on(input_qubit[3])) # number=25
        ...
        c.append(cirq.Y.on(input_qubit[3])) # number=27
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2]))  # number=24
        c.append(cirq.X.on(input_qubit[3]))  # number=12
        c.append(cirq.CNOT.on(input_qubit[1],input_qubit[2])) # number=31
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq962.csv","w+")
