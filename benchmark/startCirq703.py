...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=33
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=36
    c.append(cirq.Z.on(input_qubit[4])) # number=37
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=38
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq703.csv","w+")
