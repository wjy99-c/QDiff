...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[3],input_qubit[0]) # number=52
    prog.z(input_qubit[3]) # number=53
    prog.cx(input_qubit[3],input_qubit[0]) # number=54
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy1910.csv","w")
