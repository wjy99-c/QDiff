...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(-0.4084070449666731).on(input_qubit[3])) # number=29
    c.append(cirq.H.on(input_qubit[3]))  # number=4
    c.append(cirq.H.on(input_qubit[0])) # number=12
    c.append(cirq.Y.on(input_qubit[1])) # number=26
    c.append(cirq.rx(-1.6524777357882312).on(input_qubit[3])) # number=15
    ...
    c.append(cirq.Y.on(input_qubit[1])) # number=30
    c.append(cirq.rx(-1.3414600630828417).on(input_qubit[2])) # number=28
    ...
    c.append(cirq.Y.on(input_qubit[1])) # number=17
    ...
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=21
    c.append(cirq.H.on(input_qubit[2])) # number=23
    c.append(cirq.CNOT.on(input_qubit[1],input_qubit[0])) # number=22
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=24
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=25
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=31
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=32
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1760.csv","w+")
