...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Z.on(input_qubit[3])) # number=39
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3]))  # number=47
    c.append(cirq.X.on(input_qubit[3]))  # number=48
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=42
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3421.csv","w+")
