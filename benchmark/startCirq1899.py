...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1]))  # number=68
        c.append(cirq.X.on(input_qubit[1]))  # number=69
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1]))  # number=70
        ...
        c.append(cirq.X.on(input_qubit[1])) # number=67
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1899.csv","w+")
