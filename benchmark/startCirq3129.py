...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3]))  # number=16
    ...
    c.append(cirq.rx(0.6063273821428302).on(input_qubit[3])) # number=34
    c.append(cirq.rx(-2.0106192982974678).on(input_qubit[3])) # number=35
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=24
    c.append(cirq.H.on(input_qubit[0])) # number=25
    c.append(cirq.Y.on(input_qubit[2])) # number=30
    ...
    c.append(cirq.CZ.on(input_qubit[2],input_qubit[0])) # number=27
    c.append(cirq.H.on(input_qubit[0])) # number=28
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=36
    c.append(cirq.SWAP.on(input_qubit[2],input_qubit[0])) # number=37
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3129.csv","w+")
