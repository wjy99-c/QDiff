...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.y(input_qubit[1]) # number=20
    prog.y(input_qubit[1]) # number=21
    prog.h(input_qubit[0]) # number=24
    prog.cz(input_qubit[1],input_qubit[0]) # number=25
    ...
    prog.swap(input_qubit[1],input_qubit[0]) # number=31
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1093.csv","w")
