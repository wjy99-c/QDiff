...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[0],input_qubit[4]) # number=48
        prog.x(input_qubit[4]) # number=49
        prog.cx(input_qubit[0],input_qubit[4]) # number=50
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1286.csv","w")
