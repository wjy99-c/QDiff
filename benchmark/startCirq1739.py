...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(0.7099999397112932).on(input_qubit[2])) # number=10
    ...
    c.append(cirq.CZ.on(input_qubit[3],input_qubit[0])) # number=8
    c.append(cirq.H.on(input_qubit[0])) # number=9
    c.append(cirq.H.on(input_qubit[2])) # number=23
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[2])) # number=24
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=44
    c.append(cirq.X.on(input_qubit[2])) # number=45
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=46
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[2])) # number=33
    c.append(cirq.H.on(input_qubit[2])) # number=34
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=40
    c.append(cirq.X.on(input_qubit[2])) # number=41
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=42
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[2])) # number=18
    c.append(cirq.X.on(input_qubit[2])) # number=35
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1739.csv","w+")
