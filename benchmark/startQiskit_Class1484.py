...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[0],input_qubit[2]) # number=50
        prog.x(input_qubit[2]) # number=51
        prog.cx(input_qubit[0],input_qubit[2]) # number=52
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1484.csv","w")
