...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.X.on(input_qubit[1])) # number=34
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=35
    c.append(cirq.H.on(input_qubit[2]))  # number=3
    c.append(cirq.H.on(input_qubit[1])) # number=14
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=15
    c.append(cirq.H.on(input_qubit[1])) # number=16
    c.append(cirq.H.on(input_qubit[1])) # number=20
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=21
    ...
    c.append(cirq.H.on(input_qubit[1])) # number=23
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[1])) # number=24
    c.append(cirq.H.on(input_qubit[1])) # number=25
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=36
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=37
    c.append(cirq.X.on(input_qubit[1])) # number=38
    ...
    c.append(cirq.X.on(input_qubit[1])) # number=9
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1726.csv","w+")
