...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[2],input_qubit[1])) # number=22
        ...
        c.append(cirq.CNOT.on(input_qubit[4],input_qubit[1])) # number=35
        c.append(cirq.X.on(input_qubit[2]))  # number=15
        c.append(cirq.X.on(input_qubit[3]))  # number=16
        c.append(cirq.CNOT.on(input_qubit[1],input_qubit[3])) # number=27

    c.append(cirq.Y.on(input_qubit[4])) # number=36
    c.append(cirq.Y.on(input_qubit[4])) # number=37
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq900.csv","w+")
