...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=52
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=55
    c.append(cirq.X.on(input_qubit[3])) # number=56
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=57
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq474.csv","w+")
