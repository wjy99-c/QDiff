...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    prog.cx(input_qubit[4],input_qubit[0]) # number=33
    prog.cx(input_qubit[4],input_qubit[0]) # number=36
    prog.z(input_qubit[4]) # number=37
    prog.cx(input_qubit[4],input_qubit[0]) # number=38
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class703.csv","w")
