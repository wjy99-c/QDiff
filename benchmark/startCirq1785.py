...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.H.on(input_qubit[3]))  # number=67
        c.append(cirq.CZ.on(input_qubit[0],input_qubit[3]))  # number=68
        c.append(cirq.H.on(input_qubit[3]))  # number=69
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1785.csv","w+")
