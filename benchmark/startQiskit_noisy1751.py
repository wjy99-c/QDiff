...
def make_circuit(n:int) -> QuantumCircuit:
    ...
    prog.rx(1.4639821765728436,input_qubit[2]) # number=29
    prog.h(input_qubit[2]) # number=33
    prog.cz(input_qubit[0],input_qubit[2]) # number=34
    ...
    prog.y(input_qubit[3]) # number=28
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_noisy1751.csv","w")
