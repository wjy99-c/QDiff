...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=81
    c.append(cirq.X.on(input_qubit[1])) # number=82
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[1])) # number=83
    ...
    c.append(cirq.H.on(input_qubit[2])) # number=80
