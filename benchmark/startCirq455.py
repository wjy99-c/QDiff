...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.H.on(input_qubit[3])) # number=52
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3])) # number=53
    c.append(cirq.H.on(input_qubit[3])) # number=54
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq455.csv","w+")
