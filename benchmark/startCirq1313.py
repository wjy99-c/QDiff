...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=28
    c.append(cirq.Z.on(input_qubit[2])) # number=29
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=30
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1313.csv","w+")
