...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=26
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=27
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq799.csv","w+")
