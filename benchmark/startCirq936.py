...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Y.on(input_qubit[2])) # number=33
    ...
    for i in range(2):
        ...
        c.append(cirq.CZ.on(input_qubit[4],input_qubit[3])) # number=31
        ...
        c.append(cirq.CNOT.on(input_qubit[3],input_qubit[1])) # number=25
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq936.csv","w+")
