...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=58
    c.append(cirq.X.on(input_qubit[3])) # number=59
    c.append(cirq.CNOT.on(input_qubit[0],input_qubit[3])) # number=60
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq488.csv","w+")
