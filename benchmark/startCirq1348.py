...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[1],input_qubit[0])) # number=32
    c.append(cirq.SWAP.on(input_qubit[1],input_qubit[0])) # number=33
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1348.csv","w+")
