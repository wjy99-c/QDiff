...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CZ.on(input_qubit[1],input_qubit[0])) # number=27
    c.append(cirq.H.on(input_qubit[0])) # number=28
    c.append(cirq.Z.on(input_qubit[1])) # number=24
    c.append(cirq.CNOT.on(input_qubit[3],input_qubit[2])) # number=38
    ...
    c.append(cirq.rx(2.8902652413026093).on(input_qubit[2])) # number=13
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3]))  # number=36
    ...
    c.append(cirq.Y.on(input_qubit[1])) # number=11
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq3183.csv","w+")
