...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[0],input_qubit[1])  # number=64
        prog.x(input_qubit[1])  # number=65
        prog.cx(input_qubit[0],input_qubit[1])  # number=66
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1673.csv","w")
