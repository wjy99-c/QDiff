...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=40
    c.append(cirq.Z.on(input_qubit[2])) # number=41
    c.append(cirq.CNOT.on(input_qubit[2],input_qubit[0])) # number=42
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq2695.csv","w+")
