...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=48
        c.append(cirq.X.on(input_qubit[4])) # number=49
        c.append(cirq.CNOT.on(input_qubit[0],input_qubit[4])) # number=50
