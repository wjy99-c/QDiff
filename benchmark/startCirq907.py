...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(-0.03141592653589796).on(input_qubit[1])) # number=37
    for i in range(2):
        ...
        c.append(cirq.CNOT.on(input_qubit[4],input_qubit[2])) # number=25
        ...
        c.append(cirq.CZ.on(input_qubit[0],input_qubit[2]))  # number=32
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq907.csv","w+")
