...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=59
    c.append(cirq.Z.on(input_qubit[4])) # number=60
    c.append(cirq.CNOT.on(input_qubit[4],input_qubit[0])) # number=61
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1809.csv","w+")
