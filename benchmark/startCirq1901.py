...
def make_circuit(n: int, input_qubit):
    ...
    for i in range(2):
        ...
        c.append(cirq.H.on(input_qubit[2]))  # number=68
        c.append(cirq.CZ.on(input_qubit[0],input_qubit[2]))  # number=69
        c.append(cirq.H.on(input_qubit[2]))  # number=70
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq1901.csv","w+")
