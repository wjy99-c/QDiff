...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.SWAP.on(input_qubit[1],input_qubit[0])) # number=47
    c.append(cirq.SWAP.on(input_qubit[1],input_qubit[0])) # number=48
    # circuit end
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq390.csv","w+")
