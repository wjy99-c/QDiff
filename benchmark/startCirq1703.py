...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.rx(0.9770353152664255).on(input_qubit[1])) # number=24
    ...
    c.append(cirq.CZ.on(input_qubit[0],input_qubit[3])) # number=30
    ...
    c.append(cirq.rx(-1.3288936924684827).on(input_qubit[3])) # number=28
    c.append(cirq.X.on(input_qubit[3])) # number=11
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=38
    c.append(cirq.SWAP.on(input_qubit[3],input_qubit[0])) # number=39
    # circuit end
