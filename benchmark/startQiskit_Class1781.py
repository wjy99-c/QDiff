...
def make_circuit(n:int,f) -> QuantumCircuit:
    ...
    for i in range(repeat):
        ...
        prog.cx(input_qubit[0],input_qubit[3])  # number=67
        prog.x(input_qubit[3])  # number=68
        prog.cx(input_qubit[0],input_qubit[3])  # number=69
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startQiskit_Class1781.csv","w")
