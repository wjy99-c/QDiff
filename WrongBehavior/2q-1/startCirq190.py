...
def make_circuit(n: int, input_qubit):
    ...
    c.append(cirq.Z.on(input_qubit[1])) # number=16
    ...
    c.append(cirq.Z.on(input_qubit[1])) # number=12
    ...
    c.append(cirq.Z.on(input_qubit[0])) # number=9
    ...
    c.append(cirq.Z.on(input_qubit[0])) # number=2
...
if __name__ == '__main__':
    ...
    writefile = open("../data/startCirq190.csv","w+")
